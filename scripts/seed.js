...
const REAL_QUESTIONS = {
  "Mathematics": {
    "7": [
      ...
      { text: "Find the average of 209g, 350g and 650g.", marks: 2, answer: "403g", options: ["401g", "401g", "403g", "4 003g"] },
      ...
      { text: "The average of 6 items is 225 grams. Find the sum of the items.", marks: 2, answer: "1350 grams", options: ["1 150 grams", "1 250 grams", "1 350 grams", "1 450 grams"] },
  ...
  "Geography": {
    ...
    "7": [
      ...
      { text: "What is the main cash crop grown in Zambia?", marks: 3, answer: "Maize (or cotton, tobacco)", options: ["Maize", "Rice", "Coffee only", "Bananas"] },
    ],
  },
  "History": {
    "6": [
      ...
      { text: "Who was the famous female freedom fighter who opposed British rule?", marks: 3, answer: "Alice Lenshina (or Julia Chikamoneka)", options: ["Alice Lenshina", "Margaret Thatcher", "Queen Elizabeth II", "Angela Merkel"] },
      { text: "Which people first lived in the area that is now Zambia?", marks: 3, answer: "The Khoisan (Bushmen)", options: ["The Khoisan", "The British", "The Portuguese", "The Americans"] },
  ...
  "Science": {
    ...
    "6": [
      ...
      { text: "Name one thing living things need to survive.", marks: 2, answer: "Water (or food, air, sunlight)", options: ["Water", "Money", "Sand", "Stone"] },
  ...
  "Social Studies": {
    ...
    "6": [
      ...
      { text: "How many colours are on the Zambian flag?", marks: 2, answer: "Four (green, orange, red, black)", options: ["Three", "Four", "Two", "Five"] },
      { text: "Name one language spoken in Zambia.", marks: 2, answer: "Bemba (or Nyanja, Tonga, Lozi)", options: ["Bemba", "Swahili", "Zulu", "Xhosa"] },
      { text: "What is the name of the river that flows through the capital city Lusaka?", marks: 2, answer: "Kafue River", options: ["Zambezi", "Luangwa", "Kafue", "Kafue"] },
      { text: "In which province is the Copperbelt?", marks: 2, answer: "Copperbelt Province", options: ["Southern", "Copperbelt", "Eastern", "Western"] },
  ...
  "Principles of Accounts": {
    "6": [
      ...
      { text: "What do we call money you receive for work you do?", marks: 2, answer: "Income (wages or salary)", options: ["Income", "Debt", "Tax", "Interest"] },
  ...
  "Commerce": {
    "6": [
      ...
      { text: "What do we call a person who sells goods?", marks: 2, answer: "A seller (trader)", options: ["A seller", "A buyer", "A farmer", "A nurse"] },
      ...
      { text: "What is the name of the biggest market in Lusaka?", marks: 3, answer: "Soweto Market (or City Market)", options: ["Soweto Market", "State House", "UNZA", "Airport"] },
  ...
  "Agricultural Science": {
    ...
    "7": [
      ...
      { text: "What do we call the process of putting seeds in the ground?", marks: 2, answer: "Sowing (planting)", options: ["Sowing", "Harvesting", "Threshing", "Weeding"] },
  ...
  "Creative and Technology Studies": {
    "6": [
      ...
      { text: "Which material is used to make a chalkboard?", marks: 3, answer: "Slate (or painted board)", options: ["Slate", "Paper", "Plastic", "Rubber"] },
    ...
    "7": [
      ...
      { text: "Which material is a good insulator for an oven glove?", marks: 3, answer: "Cotton (or wool)", options: ["Cotton", "Copper", "Iron", "Silver"] },
      ...
      { text: "Which of these is used to make a woven mat?", marks: 3, answer: "Reeds (or grass)", options: ["Reeds", "Iron", "Plastic bags only", "Wood planks"] },
  ...
  "English Literature": {
    "6": [
      ...
      { text: "What do we call a short funny story?", marks: 3, answer: "A joke (anecdote)", options: ["A joke", "A novel", "An essay", "A poem"] },
